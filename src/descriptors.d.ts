 ...
 * String names can be comma-separated list of names.
 */
 ...
 *
 * @param target the object to add the descriptor to.
 * @param dict a dictionary where the keys are the names of the descriptors to add and the values are the descriptors.
 * @param force if truthy, the descriptor will be added even if it already exists in the target.
 * @returns the target object.
 */
 ...
 * @param dict a dictionary where the keys are the names of the getters to add and the values are the getters.
 ...
 * A key is a name of a source property and a value is a name of an alias: a comma-separated list of names,
 * a symbol, or an array of strings and symbols.
 */
 ...
 *               It can also be an object with keys as strings or symbols denoting a name of a descriptor from the source object.
 *               An associated value is a value suitable as the `names` argument of `addDescriptors()`.
 * @param force if truthy, the descriptor will be added even if it already exists in the target.
 * @returns the target object.
 */
